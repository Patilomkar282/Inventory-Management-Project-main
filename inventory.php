...
if (isset($_POST['additem'])) {
    ...
    $sql = "INSERT INTO inventory_data (serial_no, purchase_date, inventory_description, labrotary, purchase_price, dsr_number,image_url)

            VALUES ('$serial_no', '$purchase_date', '$inventory_description', '$labrotary', '$purchase_price', '$dsr_number','$image_url')";
