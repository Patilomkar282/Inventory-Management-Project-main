...
<body>
    ...
    $sql = "SELECT serial_no,Inventory_Description,labrotary,image_url FROM inventory_data";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='" . $row["image_url"] . "' target='_blank'><img src='data:image/jpeg;base64," . base64_encode($row["image_url"]) . "' alt='QR Code' style='max-width: 100px;'></a></td>";
            echo "</tr>";
        }
    } else {
